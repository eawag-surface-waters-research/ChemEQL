...
class FileInfoWindow extends JInternalFrame
{
	...
	static class AdsorptionParamsTable extends MyTable
	{
		...
		public TableCellRenderer getCellRenderer(int row, int col) {
			...
			case 1:
				return digits2Renderer;
			case 2:
				return rightAlignRenderer;
			case 3:
				return digits3Renderer;
			case 4:
				return col == 1 ? digits3Renderer : stringRenderer;
			case 5:
				return digits2Renderer;
			case 6:
				return digits2Renderer;
