			...
			SwingUtilities.invokeAndWait(new Runnable()
			{
				public void run()
				{
					...
					switch (main.outputFormat) {
						case REGULAR: updateRegular(); break;
						case INTERVAL: updateInterval(); break;
							// Aufzeichnen(DrawIntervalLinear, outputWindow);
							// Aufzeichnen(DrawLogarithmic, outputWindow);
						case PXPY_DIAGRAM: updatePxPy(); break; // Aufzeichnen(DrawpXpYdata, outputWindow);
					}
				}
			});
		}
