...
class ModelEnum extends Object
{
	...
	{
		if (n.equals(CONSTANT_CAP.getName())) return CONSTANT_CAP;
		if (n.equals(DIFFUSE_GTL.getName())) return DIFFUSE_GTL;
		if (n.equals(STERN_L.getName())) return STERN_L;
		if (n.equals(TRIPLE_L.getName())) return TRIPLE_L;
		return null;
	}
